 ...
 *┃➤* _${usedPrefix}Proveedor / Deseas Vender Burbujai ?_
 *┃➤* _${usedPrefix}PinguiComu / Publicidad De La Comunidad Burbujai_
 ...
 *┃➤* _${usedPrefix}minarBurbujaicoins | minarcoins_
 ...
 *┃➤* _${usedPrefix}añadircoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝗕𝘂𝗿𝗯𝘂𝗷𝗮 𝗕𝗼𝘁 💞', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
